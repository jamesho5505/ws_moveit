...
last_fsr  = {
    "t": None,
    "f1": None, "v1": None, "g1": None,
    "f2": None, "v2": None, "g2": None,
}
...
def main():
    ...
    with open(CSV_PATH, "w", newline="") as f:
        ...
        w.writerow([
            ...
            "fsr1_f", "fsr1_vout_V", "fsr1_G_Siemens",
            "fsr2_f", "fsr2_vout_V", "fsr2_G_Siemens",
        ])
        ...
        while not stop_flag:
            ...
            with lock:
                ...
                a1 = last_fsr["f1"]; v1 = last_fsr["v1"]; g1 = last_fsr["g1"]
                a2 = last_fsr["f2"]; v2 = last_fsr["v2"]; g2 = last_fsr["g2"]
